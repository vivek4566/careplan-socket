...
function default_1(app, impl) {
    app.post('/Plans/create', function (req, res) {
        try {
            function __body() {
    ...
    app.get('/Plans/delete', function (req, res) {
        try {
    ...
    app.get('/Plans/get', function (req, res) {
        try {
    ...
    app.get('/Plans/getAll', function (req, res) {
        try {
    ...
    app.put('/Plans/update', function (req, res) {
        try {
            function __body() {
                const __contentType = req.get('Content-Type');
                const __mimeType = __contentType ? __contentType.replace(/;.*/, '') : undefined;
